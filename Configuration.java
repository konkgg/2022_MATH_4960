...
public class Configuration {
   ...
   public Configuration(File fileIn)
   {
   ...
   public void SaveConfigMethod(String name, String path)
   {
      ...
      try(FileWriter wr = new FileWriter(new File(path, name));
   ...
   {
        return permutations[a].numbersSum;
   }
   ...
   public boolean rowSumIsEqual()
   {
      for(int i = 0; i < dieCount - 1; i++)
      {
         if(getRowSum(i) != getRowSum(i + 1))
            return false;
      }
      return true;
   }
